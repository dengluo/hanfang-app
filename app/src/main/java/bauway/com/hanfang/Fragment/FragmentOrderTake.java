...
public class FragmentOrderTake extends Fragment implements View.OnClickListener {
    ...
    private Boolean btok = false;//蓝牙地址是否没被绑定
...
//                mHandler.sendEmptyMessage(99);
            ...
            case R.id.iv_device_drug_codesss:
                if (isok) {
                    ...
                    openCameraIntent.putExtra("shebei", "device1");
            ...
            case R.id.iv_device_drug_codesss2:
                if (isok) {
                    Intent openCameraIntent = new Intent(context, CaptureActivity.class);
                    openCameraIntent.putExtra("shebei", "device2");
                    startActivityForResult(openCameraIntent, 0);
                } else {
                    ToastUtils.showShortSafe(R.string.tip_validate);
                }
    ...
    private void empower(final String code, final String sn) {
        ...
        if (tv_frag_device_ypcode.getText().equals("3S") && tv_frag_device_ypcode.getText().equals("3MIN") && tv_frag_device_ypcode.getText().equals("1H") && tv_frag_device_ypcode.getText().equals("45H") && tv_frag_device_ypcode.getText().equals("90H") && tv_frag_device_ypcode.getText().equals("180H")) {
...
//                        Log.i("tv_frag_device_ypcode", "=="+tv_frag_device_ypcode.getText().toString());
                                            ...
                                            } else if (tv_frag_device_ypcode.getText().toString().equals("3S")) {
                                                mSmaManager.write(SmaManager.SET.EMPOWER_TIME, 0.05 + "");
...
//                        Log.i("tv_frag_device_ypcode", "=="+tv_frag_device_ypcode.getText().toString());
                        ...
                        ToastUtil.showShortToast(context, getString(R.string.device_code_error));
                    }
                } else {
...
//                        return;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1) {
            ...
            Log.e("scanResult time==", "==");
            if (scanResult.equals("3S") || scanResult.equals("3MIN") || scanResult.equals("1H") || scanResult.equals("45H") || scanResult.equals("90H") || scanResult.equals("180H")) {
                tv_frag_device_ypcode.setText(scanResult);
            } else {
        ...
        if (resultCode == 2) {
            Bundle bundle = data.getExtras();
            String scanResult = bundle.getString("result");
            Log.e("scanResult device==", scanResult);
            if (scanResult.length() > 12) {
                tv_frag_device_ypcode2.setText(scanResult.substring(scanResult.length() - 12, scanResult.length()));
            } else {
                tv_frag_device_ypcode2.setText(scanResult);
            }
        }
    }
}
