...
public class DeviceSettingActivity4 extends BaseActivity {
    ...
    private static final String TAG = "DeviceSettingActivity4";
    ...
    protected int getLayoutRes() {
        return R.layout.activity_device_setting4;
    }
    ...
    protected void initView() {
        ...
        time = getIntent().getIntExtra("time4",0);
        fengsu = getIntent().getIntExtra("fengsu4",0);
        wendu = getIntent().getIntExtra("wendu4",0);
        L.e("time4"+time+"fengsu4"+fengsu+"wendu4"+wendu);
        initWheelTime();
        initWheelFengsu();
        initWheelWendu();
    }
    ...
    protected void init(Bundle savedInstanceState) {
        ctx =DeviceSettingActivity4.this;
...
//            mDebugViewManager = new DebugViewManager(this);
        ...
        editor.putString("scanResult4", "未输入");
        editor.commit();
    }
...
//                View.VISIBLE);
        if (mSmaManager.getNameAndAddress()[0] == null && mSmaManager.getNameAndAddress()[0] == "") {
            ...
            mStrDevicename = sharedPreferences.getString("deviceName4", "");
            ...
            String scanResult = sharedPreferences2.getString("scanResult4", "");
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_device_setting_save:
                SharedPreferences sp1 = ctx.getSharedPreferences("WENDU4",
                        Activity.MODE_PRIVATE);
                SharedPreferences.Editor editor1 = sp1.edit();
                editor1.putString("wendu4", mWendu1);
                editor1.commit();

                SharedPreferences sp2 = ctx.getSharedPreferences("FENGSU4",
                        Activity.MODE_PRIVATE);
                SharedPreferences.Editor editor2 = sp2.edit();
                editor2.putString("fengsu4", mFengsu1);
                editor2.commit();

                SharedPreferences sp3 = ctx.getSharedPreferences("TIME4",
                        Activity.MODE_PRIVATE);
                SharedPreferences.Editor editor3 = sp3.edit();
                editor3.putString("time4", mTime1);
                editor3.commit();
                ToastUtil.showShortToast(ctx,this.getString(R.string.device_save_success));
                finish();
                break;
            case R.id.ll_device_drug_code:
                startActivity(new Intent(DeviceSettingActivity4.this, CaptureActivity.class).putExtra("shebei","device4"));
                break;
...
//                }
                ...
                startActivity(new Intent(DeviceSettingActivity4.this, BindDeviceActivity.class).putExtra("shebei","device4"));
                break;
